...
abstract class Bank {
    private balance = 0; 
    public accountNumber = "sfa"
    protected accountHolderName = "John";
...
const student1:IStudent = new Student('John', 22, true, ['Math', 'Science']);
const user1:IUser = new User('John', 22, true);
